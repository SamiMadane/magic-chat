...
class _$SettingsInitialImpl implements _SettingsInitial {
...
abstract class _SettingsInitial implements SettingsState {
  const factory _SettingsInitial() = _$SettingsInitialImpl;
}
...
class _$SettingsErrorImpl implements SettingsError {
  const _$SettingsErrorImpl(this.error);
...
abstract class SettingsError implements SettingsState {
  const factory SettingsError(final String error) = _$SettingsErrorImpl;
