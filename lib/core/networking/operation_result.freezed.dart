...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$OperationResultCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'OperationResult<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements OperationResult<T> {
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$OperationResultCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'OperationResult<$T>.failure(error: $error)';
  }
...
abstract class Failure<T> implements OperationResult<T> {
